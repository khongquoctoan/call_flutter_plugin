package callfluttersdk.mobile.call_flutter_plugin.sip_manager

import android.content.Context
import android.util.Log
import callfluttersdk.mobile.call_flutter_plugin.CallFlutterPlugin
import org.linphone.core.*
import callfluttersdk.mobile.call_flutter_plugin.model.SipConfiguration
import io.flutter.plugin.common.MethodChannel.Result
import callfluttersdk.mobile.call_flutter_plugin.utils.*
            ...
            when (state) {
                ...
                Call.State.Released -> {
                    if(isMissed(call.callLog)) {
                        ...
                        // CallFlutterPlugin.eventSink?.success(data)
                    }
                }
                Call.State.End -> {
                    Log.d(TAG, "End")
