package callfluttersdk.mobile.call_flutter_plugin
...
import callfluttersdk.mobile.call_flutter_plugin.model.SipConfiguration
import callfluttersdk.mobile.call_flutter_plugin.sip_manager.SipManager

/** FlutterCallFlutterPlugin */
class CallFlutterPlugin : FlutterPlugin, MethodCallHandler, EventChannel.StreamHandler {
  ...
  override fun onAttachedToEngine(@NonNull flutterPluginBinding: FlutterPlugin.FlutterPluginBinding) {
    methodChannel = MethodChannel(flutterPluginBinding.binaryMessenger, "flutter_call_flutter_plugin_method_channel")
    methodChannel.setMethodCallHandler(this)

    eventChannel = EventChannel(flutterPluginBinding.binaryMessenger, "flutter_call_flutter_plugin_event_channel")
